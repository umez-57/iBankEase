...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $transaction_query = "
        ...
        VALUES ('$username', 'Credited', '$amount', '$new_balance', 'STAFF', 'STAFF', (SELECT ifsc_code FROM customer_accounts WHERE username = '$username'), NOW())
    ";
    ...
    $action_log_query = "
        ...
        VALUES ('$staff_username', 'Deposit', '$username', '$amount', 'Deposited by Staff', NOW())
    ";
